    ...
    const startWatching = async () => {
      try {
        ...
        headingSubscription = await ExpoLocation.watchHeadingAsync((newHeading) => {
          const nextHeading =
            newHeading.trueHeading >= 0 ? newHeading.trueHeading : newHeading.magHeading;
                ...
                <View style={styles.cardInfo}>
                  ...
                  <View style={styles.cardFooter}>
                    ...
                    >
                      ...
                      <Text style={[styles.mapButtonText, { color: colors.textSecondary }]}>
                        Maps
                      </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        displayItem.sourceURL && Linking.openURL(displayItem.sourceURL)
                      }
