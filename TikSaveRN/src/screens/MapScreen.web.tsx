...
export default function MapScreen({ navigation }: any) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            {mapError && (
                <View style={[styles.mapMessage, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <View style={[styles.headerOverlay, { paddingTop: insets.top + 16 }]}>
                <View style={[styles.headerBlur, { backgroundColor: colors.glass, borderColor: colors.glassBorder }]}>
                    <Text style={[styles.headerTitle, { color: colors.text }]}>Discover</Text>
                </View>
            </View>
        </View>
